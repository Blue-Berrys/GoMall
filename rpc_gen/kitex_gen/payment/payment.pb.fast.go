...
func (x *CreditCardInfo) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.CreditCardCvv, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *CreditCardInfo) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 2, x.GetCreditCardCvv())
	return offset
}
...
func (x *CreditCardInfo) sizeField2() (n int) {
	...
	n += fastpb.SizeString(2, x.GetCreditCardCvv())
	return n
}
