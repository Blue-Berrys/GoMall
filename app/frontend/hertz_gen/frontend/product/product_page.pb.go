...
type ProductReq struct {
	...
	Id uint32 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" query:"id"` //表示在 HTTP 请求的 QueryString 中获取名为 id 的参数，例如：/product?id=123
}
...
type SearchProductsReq struct {
	...
	Q string `protobuf:"bytes,1,opt,name=q,proto3" json:"q,omitempty" query:"q"` // 从query=q里获取数据
}
...
var file_product_page_proto_rawDesc = []byte{
	...
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x42, 0x6c, 0x75, 0x65, 0x2d, 0x42, 0x65, 0x72,
	0x72, 0x79, 0x73, 0x2f, 0x47, 0x6f, 0x4d, 0x61, 0x6c, 0x6c, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x66,
